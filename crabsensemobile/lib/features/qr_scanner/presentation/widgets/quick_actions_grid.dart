...
class QuickActionsGrid extends StatelessWidget {
  ...
  static const _items = <(ScanQuickAction, IconData, String)>[
    ...
    (ScanQuickAction.aiDetection, Icons.smart_toy_outlined, 'AI Detection'),
    ...
    (ScanQuickAction.cameraLive, Icons.camera_alt_outlined, 'Camera Live'),
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      itemBuilder: (context, i) {
        final item = _items[i];
        return Material(
          color: CrabSenseColors.container.withValues(alpha: 0.85),
          ...
          child: InkWell(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Icon(item.$2, color: CrabSenseColors.primary, size: 26),
