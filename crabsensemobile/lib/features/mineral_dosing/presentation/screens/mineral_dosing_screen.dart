...
/// Màn tính liều khoáng Ca/Mg cho nước RAS.
///
/// Bốn nhóm giá trị được tách thành bốn thẻ riêng để nông dân không lẫn:
///   1. Đã đo (test)        — số thực tế
///   2. Mục tiêu áp dụng    — đề xuất theo độ mặn hoặc người dùng nhập
///   3. Còn thiếu           — chênh lệch
///   4. Liều hoá chất       — gram CaCl2 / MgCl2 cần châm
        ...
        child: Column(
          ...
          children: [
            ...
            _field(
              ...
              label: 'Độ mặn mong muốn (không bắt buộc)',
              suffix: '‰',
