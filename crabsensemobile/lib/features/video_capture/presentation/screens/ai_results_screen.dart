      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              const Text(
                '?? tin c?y th?p ? C?n ki?m tra th? c�ng',
                style: TextStyle(
                  color: kHomeOrange,
              ...
              const Text(
                '?? tin c?y AI d??i 70%. Vui l�ng x�c minh '
                'b?ng ki?m tra th? c�ng.',
              ...
              OutlinedButton.icon(
                ...
                label: const Text('B?t ??u ki?m tra th? c�ng'),
...
class _ConfidenceScoreCard extends StatelessWidget {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  'Ph�n t�ch ${_formatTime(detection.analyzedAt)}',
  ...
  String get _confidenceLabel {
    ...
    if (pct >= 70) return 'Tin c?y trung b�nh';
    return 'Tin c?y th?p ? c?n x�c minh th? c�ng';
  }
  ...
  String _formatTime(DateTime dt) {
    ...
    if (diff.inMinutes < 60) return '${diff.inMinutes} ph�t tr??c';
...
class _HealthIndicatorCard extends StatelessWidget {
  ...
  String get _healthLabel {
    switch (healthStatus) {
      case HealthStatus.normal:
        return 'C�c ch? s? b�nh th??ng';
      case HealthStatus.disease:
        return 'Ph�t hi?n d?u hi?u b?nh ? x? l� s?m';
      case HealthStatus.stress:
        return 'C� d?u hi?u stress ? ki?m tra ?i?u ki?n';
      case HealthStatus.unknown:
        return 'Kh�ng x�c ??nh ???c t�nh tr?ng s?c kh?e';
    }
  }
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                'Cua ph�t hi?n (${detectedCrabs.length})',
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                isCorrect
                    ? 'B?n ?�nh d?u k?t qu? l� ?�ng'
                    : 'B?n ?�nh d?u k?t qu? l� Sai',
                style: TextStyle(
                  color: isCorrect ? kHomeGreen : Colors.redAccent,
                  fontSize: 14,
                  fontWeight: FontWeight.w600,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            const Text(
              'Ph?n h?i c?a b?n gi�p c?i thi?n ?? ch�nh x�c AI',
              style: TextStyle(color: Colors.white70, fontSize: 12),
            ),
            const SizedBox(height: 12),
            Row(
