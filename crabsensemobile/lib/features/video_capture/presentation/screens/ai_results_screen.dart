      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              const Text(
                'Low Confidence — Manual Inspection Needed',
                style: TextStyle(
...
class _HealthIndicatorCard extends StatelessWidget {
  ...
  String get _healthLabel {
    switch (healthStatus) {
      ...
      case HealthStatus.disease:
        return 'Disease symptoms detected — treat promptly';
      case HealthStatus.stress:
        return 'Stress indicators present — check conditions';
      case HealthStatus.unknown:
  ...
  Widget build(BuildContext context) => const Center(
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: 16),
        Text('Loading AI results…', style: TextStyle(color: CrabSenseColors.textSecondary)),
      ],
    ),
  );
}
